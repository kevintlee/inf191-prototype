$(document).ready(function() {
	/*
	var twitterAPI = "http://search.twitter.com/search.json?q=UCIrvineHealth&ucirvine&rpp=20&callback=?";
	  $.getJSON( twitterAPI, {
	    tags: "",
	    tagmode: "any",
	    format: "json"
	...
	*/
	...
	// json call to twitter to request tweets containing our keyword, in this case 'UCIrvineHealth' & 'UCIrvine'
	$.getJSON("http://search.twitter.com/search.json?q=ucirvine&UCIrvineHealth&rpp=40&callback=?", function(data) {
